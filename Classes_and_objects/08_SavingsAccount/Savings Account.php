...
Use the class method to calculate the monthly interest. After the last iteration, the program should display the ending balance,
...
class SavingsAccount
{
    ...
    public function subtractAmountOfWithdrawal(): void
    {

    }

    public function addAmountOfDeposit(): void
    {

    }

    public function addAmountOfMonthlyInterest(): void
    {

    }
}

$account = new SavingsAccount((int)readline("EHow much money is in the account?: "));
